...
public class Utility extends Activity {
    ...
    public static final int num_days_experiment_length = 31;
    public static final int year_start = 2016;
    public static final int month_start = 10; // start from 0
    public static int day_start = 1;
    public static int hour_start = 8;
    ...
    public static void initSettings(final Context context) {
        ...
        Utility.LogInType = SP.getString("LogInType", Common.LOGIN_TYPE_MULTI_QUESTION);
    ...
    public static String convertParentEMAValueToDescription(int value) {
        switch(value) {
            case 1:
